<template>
  <article class="prose max-w-none">
    ...
    <p>
      ...
      UV, sin embargo, este tipo de cáncer puede ocurrir en áreas no expuestas
    ...
    <p>
      Existen dos clasificaciones para los tipos de cáncer de piel, los cánceres
      de tipo melanoma y no melanoma.
    </p>
    <p>
